/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3b296e7c601da57a93f7be293a18c779)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 
interface __BaseEnv_Env {
	CONFIG_KV: KVNamespace;
	ACC4SSR_INI: "https://raw.githubusercontent.com/james-li/ACL4SSR/main/Clash/config/ACL4SSR_Online_MultiCountry.ini";
	FILTER_SITE: "剩余流量:流量剩余:套餐到期:套餐过期:订阅到期:订阅过期:到期时间:到期日期:过期时间:过期日期:traffic remaining:traffic left:quota remaining:quota left:remaining traffic:left traffic:remaining quota:left quota";
	ADMIN_KEY: string;
	USER_KEY: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACC4SSR_INI" | "FILTER_SITE" | "ADMIN_KEY" | "USER_KEY">> {}
}
